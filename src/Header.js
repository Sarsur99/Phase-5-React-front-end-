  ...
  return (
    <div className="flex items-center justify-between">
      <div className="w-1/2 flex items-center">
        ...
        <h1 className="text-3xl font-bold ml-4">{name}</h1>
      </div>
      <div className="w-1/2 flex items-center justify-end">
        <div className="text-2xl font-bold mr-4">{avg_score.toFixed(1)}</div>
        ...
        <div className="text-2xl font-bold ml-4">{total} Reviews</div>
      </div>
    </div>
  );
};
